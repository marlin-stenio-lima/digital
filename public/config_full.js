// Configuração inicial do Curso de Pedreiros
const initialCourseData = {
  courseName: "Curso Mestre de Obras & Pedreiro Profissional",
  bonusRedirectUrl: "https://aprendaemcasaagora.com/", // Link para o qual o módulo bônus irá redirecionar
  adminPassword: "Apex@2026", // Senha simples padrão
  modules: [
    {
      id: 1,
      title: "Módulo 1 - Estrutura da Casa",
      image: "assets/images/modulo1.jpg",
      ...
      lessons: [
        ...
        { id: "1-3", title: "Aula 3 - Como preparar argamassa", videoId: "9hShP4CQey8", description: "A dosagem (traço) perfeita de areia, cimento e aditivos para uma massa com ótima liga e aderência." },
    ...
    },
    {
      ...
      image: "assets/images/modulo2.jpg",
      ...
      lessons: [
        ...
        { id: "2-2", title: "Aula 2 - Como fazer um chpisco perfeito na alvenaria", videoId: "pKXK_pEuyFQ", description: "Como arremessar a colher de pedreiro para criar a base áspera ideal para o emboço." },
    ...
    },
    {
      ...
      image: "assets/images/modulo3.jpg",
      description: "Tudo o que você precisa saber para preparar o solo, nivelar e assentar cerâmicas e porcelanatos.",
      lessons: [
        { id: "3-1", title: "Aula 1 - Principio de um contrapiso nivelado", videoId: "KGuJOeEO5TE", description: "Limpeza da laje ou compactação da terra antes de iniciar o lançamento do contrapiso." },
...
// Exportar para uso no script.js se necessário ou deixar global
if (typeof module !== 'undefined' && module.exports) {
  module.exports = initialCourseData;
}
