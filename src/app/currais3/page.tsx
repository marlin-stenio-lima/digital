...
export default function ProjetosCurraisLP3() {
  const checkoutUrl = "https://pay.kiwify.com/rB9fmRL";
    ...
    <>
      <main className={styles.container} style={{ backgroundColor: '#f8fafc', color: '#1e293b' }}>
          ...
          <div style={{ maxWidth: '850px', width: '100%' }}>
            ...
            <div style={{ marginBottom: '2.2rem' }}>
              <span style={{ display: 'block', fontSize: '1.1rem', color: '#64748b', marginBottom: '0.3rem' }}>
                De <del style={{ color: '#ef4444' }}>$ 47,00</del> por apenas
              </span>
            ...
            <a href={checkoutUrl} className={styles.ctaButtonPulse} style={{ 
              ...
              QUERO RECEBER OS 75 PROJETOS AGORA
            </a>
        ...
        <section className={styles.finalCta} style={{ background: '#f1f5f9' }}>
          <div className={styles.finalBox} style={{ 
            ...
            <div className={styles.priceTag} style={{ color: '#475569' }}>
              ...
              <span className={styles.priceHighlight} style={{ color: '#ea580c' }}>$ 7,00</span>
            </div>
        ...
        <div className={styles.stickyMobileCta}>
          <a href={checkoutUrl} className={styles.stickyButton} style={{ backgroundColor: '#ea580c' }}>
            RECEBER PROJETOS POR $ 7,00
          </a>
        </div>
      </main>
    </>
