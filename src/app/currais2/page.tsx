...
export const metadata = {
  title: 'Projetos de Currais & Manejo Inteligente | AgroProjetos A2',
...
export default function ProjetosCurraisLP2() {
  const pId = "currais2";
      ...
      <main className={styles.container} style={{ backgroundColor: '#f8fafc', color: '#1e293b' }}>
        ...
        <section style={{ 
          ...
          <div style={{ maxWidth: '850px', width: '100%' }}>
            ...
            <Link href={`/checkout2?p=${pId}`} className={styles.ctaButtonPulse} style={{ 
        ...
        <section className={styles.finalCta} style={{ background: '#f1f5f9' }}>
          <div className={styles.finalBox} style={{ 
            ...
            <div className={styles.priceTag} style={{ color: '#475569' }}>
              ...
              <span className={styles.priceHighlight} style={{ color: '#ea580c' }}>R$ 19,90</span>
            </div>
        ...
        <div className={styles.stickyMobileCta}>
          <Link href={`/checkout2?p=${pId}`} className={styles.stickyButton} style={{ backgroundColor: '#ea580c' }}>
            RECEBER PROJETOS POR R$ 19,90
          </Link>
        </div>
      </main>
    </>
