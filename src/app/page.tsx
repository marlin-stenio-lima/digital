        ...
        <div className={styles.container}>
          <div className={styles.heroContent}>
            ...
            <h1 className={styles.heroTitle}>
              <span className={styles.orangeText}>FATURE 5X MAIS:</span> Tenha o Arsenal do Serralheiro Mestre e lucre com Móveis Industriais
            </h1>
            
            <p className={styles.heroSubtitle}>
              Pare de perder tempo com desenhos manuais. Tenha acesso a 600 projetos de móveis industriais prontos com plano de corte detalhado.
            </p>
